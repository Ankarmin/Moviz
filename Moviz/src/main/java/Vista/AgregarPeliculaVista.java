...
public class AgregarPeliculaVista extends JPanel {
    ...
    public JComboBox<String> cmbGenero; // Cambiado de JTextField a JComboBox
    public JComboBox<String> cmbAnioPublicacion; // Cambiado de JTextField a JComboBox con rangos de años
