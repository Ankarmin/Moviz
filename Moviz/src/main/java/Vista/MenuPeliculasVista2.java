...
public class MenuPeliculasVista2 extends JPanel {

	private static final long serialVersionUID = 1L;
	private JTextField txtBuscar;
	private JLabel lblBuscarPor_1;
	
	public MenuPeliculasVista2() {
		...
		lblBuscarPor_1 = DefaultComponentFactory.getInstance().createLabel("Buscar Por:");
		...
		JComboBox comboBoxAño = new JComboBox<>(año);
		...
		JComboBox comboBoxPuntuacion = new JComboBox<>(puntuacion);
		...
		JScrollPane spTablaResultado = new JScrollPane();
		spTablaResultado.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
		spTablaResultado.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panel.add(spTablaResultado, BorderLayout.CENTER);
		
		JPanel pnlGrid = new JPanel();
		spTablaResultado.setViewportView(pnlGrid);
