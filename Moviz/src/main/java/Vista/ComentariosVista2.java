...
public class ComentariosVista2 extends JPanel {
	...
	public ComentariosVista2() {
		...
		btnSalir.setIcon(new ImageIcon(ComentariosVista2.class.getResource("/Images/iconosalida.png")));
