...
public class MenuUsuarioVista extends JPanel {
	...
	public MenuUsuarioVista() {
		...
		lbTextoDeBienvenido = new JLabel();
		...
		JLabel lblNewLabel_13 = new JLabel("Algunas de nuestras películas");
		panel_35.add(lblNewLabel_13, BorderLayout.CENTER);
		lblNewLabel_13.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblNewLabel_13.setForeground(new Color(255, 255, 255));

		JPanel espacioDebajo13 = new JPanel();
		espacioDebajo13.setPreferredSize(new Dimension(0, 40));
		espacioDebajo13.setBackground(new Color(56, 58, 74));
		panel_35.add(espacioDebajo13, BorderLayout.SOUTH);
		...
		JPanel espacioDebajo16 = new JPanel();
		espacioDebajo16.setPreferredSize(new Dimension(0, 40));
		espacioDebajo16.setBackground(new Color(56, 58, 74));
		panel_30.add(espacioDebajo16, BorderLayout.SOUTH);
