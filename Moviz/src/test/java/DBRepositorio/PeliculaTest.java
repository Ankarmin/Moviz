...
class PeliculaTest {
	...
	void setUp() {
		...
		pelicula = new Pelicula(1, "Pelicula Ejemplo", 2022, "Acción", "120 min", 8, "Una película de acción",
				imagenTest);
	}
	...
	void testConstructor() {
		...
		Pelicula peliculaTest = new Pelicula(1, "Pelicula Ejemplo", 2022, "Acción", "120 min", 8,
				"Una película de acción", imagenTest);
	...
	void testToArray() {
		...
		Object[] expectedArray = { 1, "Pelicula Ejemplo", 2022, "Acción", "120 min", 8, "Una película de acción",
				imagenTest };
