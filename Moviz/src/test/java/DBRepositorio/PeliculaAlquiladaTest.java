...
class PeliculaAlquiladaTest {
	...
	void setUp() {
		...
		peliculaAlquilada = new PeliculaAlquilada(1, 10, 1, fechaAlquiler, fechaDevolucion);
	}

	@Test
	void testConstructor() {
		// PRUEBA EL CONSTRUCTOR CON PARÁMETROS
		PeliculaAlquilada peliculaAlquiladaTest = new PeliculaAlquilada(1, 10, 1, fechaAlquiler, fechaDevolucion);
		assertEquals(1, peliculaAlquiladaTest.getIdPrestamo());
		assertEquals(10, peliculaAlquiladaTest.getIdPelicula());
		assertEquals("usuarioEjemplo", peliculaAlquiladaTest.getIdUsuario());
	...
	void testSettersAndGetters() {
		...
		peliculaAlquilada.setIdUsuario(1);
		...
		assertEquals("nuevoUsuario", peliculaAlquilada.getIdUsuario());
	...
	void testToPeliculaAlquilada() {
		...
		assertEquals("nuevoUsuario", peliculaFromList.getIdUsuario());
