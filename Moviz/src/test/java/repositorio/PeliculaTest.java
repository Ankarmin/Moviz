...
class PeliculaTest {
    ...
    void testConstructorAndGetters() {
        ...
        Pelicula pelicula = new Pelicula(1, "Pelicula Test", 2024, "Drama", "120 min", puntuacion, "Sinopsis Test", image);
    ...
    void testToArray() {
        ...
        Pelicula pelicula = new Pelicula(3, "Array Pelicula", 2025, "Comedia", "110 min", puntuacion, "Sinopsis Array", image);
        Object[] expectedArray = {3, "Array Pelicula", 2025, "Comedia", "110 min", puntuacion.toPlainString(), "Sinopsis Array", image};
    ...
    void testGetColumnas() {
        ...
        expectedColumns.add("Año Estreno");
        expectedColumns.add("Género");
        expectedColumns.add("Duración");
        expectedColumns.add("Puntuación");
        expectedColumns.add("Sinopsis");
        expectedColumns.add("Imagen");
        assertEquals(expectedColumns, Pelicula.getColumnas());
    }
}
